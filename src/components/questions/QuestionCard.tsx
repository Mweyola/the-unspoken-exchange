...
export function QuestionCard({ question }: QuestionCardProps) {
  ...
  const handleOpen = () => navigate(`/questions/${question.id}`);

  return (
    <article
      className="group glass-effect rounded-xl p-5 hover-lift cursor-pointer"
      role="button"
      tabIndex={0}
      onClick={handleOpen}
      onKeyDown={(e) => {
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col items-center gap-1 pt-1">
          <button
            type="button"
            className="p-1.5 rounded-lg hover:bg-primary/20 transition-colors group/vote"
