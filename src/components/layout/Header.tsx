...
export function Header() {
  ...
  const guardListing = () => {
    if (user.level < 2) {
      toast({
        title: "Verified account required to sell",
        description: "Verify your phone and profile photo to post listings. Open Account to upgrade.",
      });
      navigate("/account");
      return false;
    }
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48 bg-card border-border">
                ...
                <DropdownMenuItem 
                  className="cursor-pointer"
                  onClick={() => {
                    if (guardListing()) setCreateListingOpen(true);
                  }}
                >
